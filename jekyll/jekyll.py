...
c.MarkdownExporter.template_path = ['/home/edoalvar/Dropbox/FLOWResearch/LabNotebook/Posts/juliacpp/jekyll'] # point this to your jekyll template file
...
if f:
    ...
    c.FilesWriter.build_directory = '/home/edoalvar/Dropbox/FLOWResearch/LabNotebook/Posts/juliacpp/jekyll' # point this to your build directory
